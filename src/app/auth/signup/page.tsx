...
import { signUpWithEmail, signInWithGoogle, getErrorMessage } from '@/lib/auth';
...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background-dark px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            Start betting on your discipline today
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input
                ...
                className="mt-1 h-4 w-4 rounded border-white/10 bg-background-dark text-primary focus:ring-primary"
              />
